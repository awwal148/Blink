...
const Puma = () => {
  ...
  const currentBrandName = "puma"

  const pumaShoes = listOfMenShoes.filter((shoe) => shoe.BrandName.toLowerCase().includes(currentBrandName));
  // Automatically set the filter to "PUMA" when the component mounts
  React.useEffect(() => {
